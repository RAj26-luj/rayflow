...
export async function seedDatabase() {
  ...
  await prisma.auditLog.create({
    data: {
      ...
      approval: 'AUTO_APPROVED',
      result: 'SUCCESS',
      reason: 'Customer completed explicit pre-payment confirmation for Velocity Runner bundle.',
  ...
  await prisma.auditLog.create({
    data: {
      ...
      approval: 'AUTO_APPROVED',
      result: 'SUCCESS',
      reason: 'Razorpay payment captured and HMAC-SHA256 signature verified server-side.',
