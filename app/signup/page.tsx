    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 flex items-center justify-center p-4 selection:bg-amber-100 selection:text-amber-900">
      <div className="w-full max-w-md bg-white rounded-md border border-stone-200 p-6 sm:p-8 shadow-2xs space-y-5">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-stone-900 tracking-tight">Create Merchant Account</h1>
          <p className="text-xs text-stone-500">Register your store to govern growth rules & Razorpay checkout.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
          ...
          <div>
            <label className="font-semibold text-stone-700 block mb-1">Work Email</label>
            <input
              type="email"
              required
              value={email}
